...
class MaskingGenerator:
    def __init__(
            self, input_size, num_masking_patches, min_num_patches=0, max_num_patches=None,
...
if __name__ == '__main__':
    ...
    generator = MaskingGenerator(input_size=28, num_masking_patches=0, min_num_patches=0, )
    for i in range(2):
        mask = generator()
        # if mask.sum() != 118:
            # pdb.set_trace()
