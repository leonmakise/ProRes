...
if __name__ == "__main__":
    type = 'target'
    # type = 'target_sub_input'

    # split = 'train'
    split = 'test'
    if split == 'train':
        image_dir = "./datasets/low_level/derain/train/input/"
        save_path = "./datasets/low_level/{}-derain_train.json".format(type)
    elif split == 'test':
        image_dir = "./datasets/low_level/derain/test/Rain100H/input/"
        save_path = "./datasets/low_level/{}-derain_test_rain100h.json".format(type)
    else:
    ...
    for image_path in tqdm.tqdm(image_path_list):
        ...
        pair_dict["type"] = "{}_derain".format(type)
