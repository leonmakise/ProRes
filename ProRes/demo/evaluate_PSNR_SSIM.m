...
for idx_set = 1:num_set
    file_path = strcat('/sharefs/wwen/unified-vp/uip/models_inference/new3_all_lr5e-4/derain_inference_epoch14_12664/', datasets{idx_set}, '/');
    gt_path = strcat('/sharefs/wwen/unified-vp/uip/data/low_level/derain/testsets/', datasets{idx_set}, '/target/');
